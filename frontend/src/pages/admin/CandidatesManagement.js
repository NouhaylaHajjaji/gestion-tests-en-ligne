...
const CandidatesManagement = () => {
  ...
  const fetchCandidates = async () => {
    try {
      const response = await fetch('http://localhost:8080/gestion-tests-backend/api/admin/candidats');
      if (response.ok) {
  ...
  const handleValidateCandidate = async (candidateId) => {
    try {
      const response = await fetch(`http://localhost:8080/gestion-tests-backend/api/admin/candidats/${candidateId}/valider`, {
        method: 'POST'
      });
  ...
  const handleRejectCandidate = async (candidateId) => {
    try {
      const response = await fetch(`http://localhost:8080/gestion-tests-backend/api/admin/candidats/${candidateId}/rejeter`, {
        method: 'POST'
      });
  ...
  const handleSendCode = async (candidateId) => {
    try {
      const response = await fetch(`http://localhost:8080/gestion-tests-backend/api/admin/candidats/${candidateId}/envoyer-code`, {
        method: 'POST'
      });
