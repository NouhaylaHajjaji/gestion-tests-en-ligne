...
const TestsManagement = () => {
  ...
  const fetchData = async () => {
    try {
      const [questionsRes, themesRes, typesRes] = await Promise.all([
        fetch('http://localhost:8080/gestion-tests-backend/api/admin/questions'),
        fetch('http://localhost:8080/gestion-tests-backend/api/admin/themes'),
        fetch('http://localhost:8080/gestion-tests-backend/api/admin/types-questions')
      ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = editingQuestion 
        ? `http://localhost:8080/gestion-tests-backend/api/admin/questions/${editingQuestion.id}`
        : 'http://localhost:8080/gestion-tests-backend/api/admin/questions';
  ...
  const handleDelete = async (questionId) => {
    ...
    try {
      const response = await fetch(`http://localhost:8080/gestion-tests-backend/api/admin/questions/${questionId}`, {
        method: 'DELETE'
      });
